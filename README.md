...
- ✨: Experienced in front-end web development (React, HTML, CSS, JavaScript, TypeScript) and Node, Java, Python, MySQL PostGreSQL, Cypress, PlayWright, Selenium, TestNG,  Locust, JMeter
