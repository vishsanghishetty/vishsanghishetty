...
- ✨: Experienced in front-end web development (Angular, React, HTML, CSS, JavaScript, TypeScript) and Node, Java, Python, MySQL PostGreSQL, Cypress, PlayWright, Selenium, TestNG, Locust, JMeter, Mocha framework with SuperTest & Chai libraries
